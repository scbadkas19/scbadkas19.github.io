...
const socialLinks = [
  {
    name: 'GitHub',
    url: 'https://github.com/scbadkas19/',
    icon: (
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/saurabh-badkas/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Medium',
    url: 'https://medium.com/@scbadkas19',
    icon: (
        ...
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          >
            <p className="text-center text-sm text-neutral-600 dark:text-white/60">
              © {currentYear} Saurabh Badkas. All rights reserved.
            </p>
          </motion.div>
        </div>
      </div>
